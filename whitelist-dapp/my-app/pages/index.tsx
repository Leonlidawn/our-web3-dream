...
export default function Home() {
  ...
  /**
   * getListedCount:  gets the number of whitelisted addresses
   */
  const getListedCount = async () => {
    try {
      ...
      const listedCount = await whitelistContract.listedAddressCount();
      const maxListedAddresses = await whitelistContract.maxListedAddresses();

      console.log({listedCount,maxListedAddresses})
    ...
    <div>
      ...
      <div className={styles.main}>
        <div>
          ...
          <div className={styles.description}>
            {listedCount} have already joined the Whitelist
          </div>
          {renderButton()}
        </div>
        <div>
